from dataset import Garbage_lader
...
if __name__ == "__main__":
    train_dir_list="./train.csv"
    valid_dir_list="./train.csv"
    batch_size= 16
    epochs = 50
    num_classes = 6
    train_data = Garbage_lader(train_dir_list, train_flag=True)
    valid_data = Garbage_lader(valid_dir_list, train_flag=False)
    ...
    fc_inputs = model.fc.in_features  # 提取FC层的固定参数
